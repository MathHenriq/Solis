...
const CAMINHOS = {
  ...
  // Adicionados na rodada que fechou as telas restantes. Mesmo grid 24x24 e
  // mesmo traço 2 dos anteriores, desenhados contra a ampliação de cada glifo
  // nas referências 13- a 18-.
  'fala':
    'M11 5 6.5 8.8H3.4A1.4 1.4 0 0 0 2 10.2v3.6a1.4 1.4 0 0 0 1.4 1.4h3.1L11 19z M15.5 9.2a4 4 0 0 1 0 5.6 M18.4 6.3a8 8 0 0 1 0 11.4',
  'visao':
    'M3.4 4.5h17.2a1.4 1.4 0 0 1 1.4 1.4v9.8a1.4 1.4 0 0 1-1.4 1.4H3.4A1.4 1.4 0 0 1 2 15.7V5.9a1.4 1.4 0 0 1 1.4-1.4z M8.5 21h7 M12 17.1V21',
  'web':
    'M12 22a10 10 0 1 0 0-20 10 10 0 0 0 0 20z M2.5 9h19 M2.5 15h19 M12 2a15 15 0 0 1 0 20 M12 2a15 15 0 0 0 0 20',
  'arquivos':
    'M3 6.4a1.6 1.6 0 0 1 1.6-1.6h4.3l2.2 2.6h8.3A1.6 1.6 0 0 1 21 9v9.4a1.6 1.6 0 0 1-1.6 1.6H4.6A1.6 1.6 0 0 1 3 18.4z',
  'terminal':
    'M3.6 4h16.8A1.6 1.6 0 0 1 22 5.6v12.8a1.6 1.6 0 0 1-1.6 1.6H3.6A1.6 1.6 0 0 1 2 18.4V5.6A1.6 1.6 0 0 1 3.6 4z M6.4 9.2l3 2.8-3 2.8 M12.4 15.4h5.2',
  'documento':
    'M6 2.6h7.2L19 8.4v13a1.4 1.4 0 0 1-1.4 1.4H6a1.4 1.4 0 0 1-1.4-1.4V4a1.4 1.4 0 0 1 1.4-1.4z M13.2 2.6v5.8H19',
  'nota':
    'M5 3.4h14A1.6 1.6 0 0 1 20.6 5v14A1.6 1.6 0 0 1 19 20.6H5A1.6 1.6 0 0 1 3.4 19V5A1.6 1.6 0 0 1 5 3.4z M7.4 9h9.2 M7.4 12.6h9.2 M7.4 16.2h5.4',
  'mais':
    'M5.6 13.4a1.4 1.4 0 1 0 0-2.8 1.4 1.4 0 0 0 0 2.8z M12 13.4a1.4 1.4 0 1 0 0-2.8 1.4 1.4 0 0 0 0 2.8z M18.4 13.4a1.4 1.4 0 1 0 0-2.8 1.4 1.4 0 0 0 0 2.8z',
  'anterior':
    'M19 12H5 M11.4 5.4 4.8 12l6.6 6.6',
  'proximo':
    'M5 12h14 M12.6 5.4 19.2 12l-6.6 6.6',
  'sino':
    'M18.4 9.6a6.4 6.4 0 1 0-12.8 0c0 5.6-2.2 7.2-2.2 7.2h17.2s-2.2-1.6-2.2-7.2z M13.8 20.4a2 2 0 0 1-3.6 0',
  'perfil':
    'M12 22a10 10 0 1 0 0-20 10 10 0 0 0 0 20z M12 12.4a3.2 3.2 0 1 0 0-6.4 3.2 3.2 0 0 0 0 6.4z M5.8 19.4a6.6 6.6 0 0 1 12.4 0',
  'chevron':
    'M6 9l6 6 6-6',
} as const;
